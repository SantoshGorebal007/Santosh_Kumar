      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-2 gap-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-lg font-semibold mb-4">G Santosh Kumar</h3>
            <p className="text-muted-foreground mb-4 max-w-md">
              Software Engineer & Data Science Enthusiast building the future through innovative technology solutions.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.linkedin.com/in/santosh-kumar-data-analyst/"
                target="_blank"
              ...
              <a
                href="https://github.com/SantoshGorebal007"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://leetcode.com/u/Santosh_Gorebal/"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="border-t border-border mt-8 pt-8 text-center">
          <p className="text-muted-foreground flex items-center justify-center gap-2">
            Made with <Heart className="w-4 h-4 text-red-500" /> by Santosh Kumar
          </p>
        </div>
      </div>
    </footer>
