      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Let's collaborate to build something great or discuss opportunities
          </p>
        </motion.div>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <Card className="border-2 hover:border-blue-200 dark:hover:border-blue-800 transition-colors bg-background/50 backdrop-blur-sm">
                  <CardContent className="p-6 text-center">
                    ...
                    <a href="mailto:sgcherry757@gmail.com" className="text-muted-foreground hover:text-blue-600 transition-colors">
            ...
            <Card className="border-2 border-dashed border-gray-300 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-700 transition-colors bg-background/50 backdrop-blur-sm">
              ...
              <CardContent className="text-center">
                ...
                <Button className="bg-gradient-to-r from-blue-600 to-teal-600 hover:from-blue-700 hover:to-teal-700 text-white" asChild>
                  <a href="https://github.com/SantoshGorebal007" target="_blank" rel="noopener noreferrer">
